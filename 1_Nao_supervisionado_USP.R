...
"C:\Users\leona\AppData\Local\Temp\RtmpAfQiS0\downloaded_packages\DEoptimR_1.0-9.zip"

#Para instalar um pacote, preciso especificar um local da biblioteca:
  
install.packages("factoextra", lib="(C:/Users/Jessica/software/Rpackages)")
#Para carregar um pacote, também preciso especificar o local da biblioteca:
  
  library("factoextra", lib.loc="C:/Users/Jessica/software/Rpackages")
...
View(alunos_pap)
#substitui o número pela linha, ou seja, o nome do aluno deixa de ser variável...
...
#hclust - método hierarquico
#•Single Linkage-Vizinho mais próximo
#↪ Define quem agrupa pelo menor valor…
#•Complete Linkage-Vizinho mais longe
#↪ Define quem agrupa pelo maior valor…
#•AvarageLinkage-Média
#↪ Define quem agrupa pela média
#•Centroid Method –Centroíde
#↪ Define quem agrupa pela fórmula do centróide…
#•Ward´sMethod
#↪ Define quem agrupa pelo princípio da variabilidade… Só agrupa se o impacto do indivíduo entrando não for grande...
#No método hierárquico, eu defino o número de grupos que eu quero...
...
mediagrupo_alunos
#No grupo 1, temos 2 indivíduos, sendo que a média da nota em PortuguÊs é 7,5...
...
#Angus e big taste - mais calóricos... se juntaram por último...
#chicken classic - menos calórico... se juntaram primeiro...
#Escolher 2 a 3 tipos de mc donalds...
...
#juntando com a base original
#não é base padronizada, mas sim a original: mcdonalds
...
#Rodar o modelo
#centers = 2 - qtos grupos eu quero
